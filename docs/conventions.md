...
## 10) Project typography settings

Per-project markdown editor typography is configured in `project.json` under `fontSettings`.
...
Apply the settings to the project-local VS Code file with:
